...
<div id="carouselExampleIndicators" class="carousel slide d-flex justify-content-center" data-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="<?php echo IMAGES; ?>/slider-1c.jpeg" class="img img-fluid d-block w-100" alt="...">
		</div>
		<div class="carousel-item">
			<img src="<?php echo IMAGES; ?>/slider-2c.jpeg" class="img img-fluid d-block w-100" alt="...">
		</div>
		<div class="carousel-item">
			<img src="<?php echo IMAGES; ?>/slider-3c.jpeg" class=" img img-fluid d-block w-100" alt="...">
		</div>
	</div>
...
<div class="container_au col-lg-12 offset-lg-0 col-md-10 offset-md-1 col-sm-10 offset-sm-1 col-10 offset-1 do-animated do-fadeInRight">
	...
	<img src="<?php echo IMAGES; ?>/about.jpeg" alt="picture" width="500px" class="rounded mx-auto d-block justify-content-center my-5 img-fluid">
	<p class="col-lg-7">
